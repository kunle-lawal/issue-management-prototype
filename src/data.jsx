...
export const DATA = { PEOPLE, BUILDINGS, RESOURCES, QUESTION_TYPES, QUESTION_STARTERS, RULES, AMENITY_RESOURCES, AMENITY_EXAMPLES, PREVIEW_RESOURCE_SAMPLES, DEMO_CONFIGS, DEMO_REPORTS, DEMO_BOOKINGS };
