// Setup flow modals: choose how to set up, then pick a building.
const { useState: useStateModals, useMemo } = React;
...
function BuildingSelectModal({ onBack, onClose, onContinue, configured }) {
  const [selected, setSelected] = useStateModals(null);
  const [query, setQuery] = useStateModals('');
...
window.SetupModals = { SetupChoiceModal, BuildingSelectModal, ServiceNowStubModal };
